    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:flex lg:flex-col shadow-sm">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow shadow-inner">
            <ul class="flex flex-col py-4 space-y-1 px-3 mb-10">
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.dashboard') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.orders.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.orders.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.scheduled-orders.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.scheduled-orders.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.order-history.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.order-history.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.users.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.roles-permissions.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.roles-permissions.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.profile') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.profile') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.restaurants.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.restaurants.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span class="ml-3 font-medium text-sm">Restaurants</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.drivers.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.drivers.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.payments.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.payments.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <span class="ml-3 font-medium text-sm">Payments</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.revenue.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.revenue.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                        <span class="ml-3 font-medium text-sm">Revenue Management</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.withdrawals.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.withdrawals.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.commissions.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.commissions.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.offers.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.offers.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path></svg>
                        <span class="ml-3 font-medium text-sm">Offers</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.discounts.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.discounts.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.feedback.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.feedback.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.notifications.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.notifications.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                ...
                <li>
                    <a href="{{ route('admin.scheduled-notifications.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 group transition-colors px-6 {{ request()->routeIs('admin.scheduled-notifications.*') ? 'text-primary bg-indigo-50 border-l-4 border-primary rounded-r-lg' : 'text-gray-600 hover:text-gray-800 border-l-4 border-transparent' }}">
                        <svg class="w-5 h-5 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
