            ...
            @can('view_complaints')
                <li class="mb-1">
                    <a href="{{ route('admin.complaints.index') }}"
                        class="relative flex flex-row items-center h-11 focus:outline-none group transition-colors px-6 rounded-lg {{ request()->routeIs('admin.complaints.*') ? 'bg-indigo-50 text-[#4338ca] border-s-4 border-[#4338ca] font-semibold' : 'text-gray-600 hover:bg-indigo-50 hover:text-[#4338ca] border-s-4 border-transparent font-medium' }}">
                        ...
                        <span class="ms-3 text-sm">{{ __('Complaints') }}</span>
                    </a>
                </li>
                <li class="mb-1">
                    <a href="{{ route('admin.feedback.index') }}"
                        class="relative flex flex-row items-center h-11 focus:outline-none group transition-colors px-6 rounded-lg {{ request()->routeIs('admin.feedback.*') ? 'bg-indigo-50 text-[#4338ca] border-s-4 border-[#4338ca] font-semibold' : 'text-gray-600 hover:bg-indigo-50 hover:text-[#4338ca] border-s-4 border-transparent font-medium' }}">
                        ...
                        <span class="ms-3 text-sm">{{ __('Feedback') }}</span>
                    </a>
                </li>
            @endcan
