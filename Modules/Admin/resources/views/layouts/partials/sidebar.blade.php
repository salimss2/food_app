            ...
            @can('manage_settings')
                ...
                <li class="mb-1">
                    <a href="{{ route('admin.feedback.index') }}"
                        ...
                        <span class="ms-3 text-sm">{{ __('Ratings & Feedback') }}</span>
                    </a>
                </li>
                <li class="mb-1">
                    <a href="{{ route('admin.tickets') }}"
                        class="relative flex flex-row items-center h-11 focus:outline-none group transition-colors px-6 rounded-lg {{ request()->routeIs('admin.tickets*') ? 'bg-indigo-50 text-[#4338ca] border-s-4 border-[#4338ca] font-semibold' : 'text-gray-600 hover:bg-indigo-50 hover:text-[#4338ca] border-s-4 border-transparent font-medium' }}">
                        <svg class="w-5 h-5 {{ request()->routeIs('admin.tickets*') ? 'text-[#4338ca]' : 'text-gray-600 group-hover:text-[#4338ca]' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z">
                            </path>
                        </svg>
                        <span class="ms-3 text-sm">{{ __('Tickets & Complaints') }}</span>
                    </a>
                </li>
            @endcan
