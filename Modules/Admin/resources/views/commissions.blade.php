    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:flex lg:flex-col shadow-sm">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow shadow-inner">
            <ul class="flex flex-col py-4 space-y-1 px-3 mb-10">
                ...
                <li>
                    <a href="{{ route('admin.commissions.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-primary bg-indigo-50 border-l-4 border-primary px-6 rounded-r-lg group transition-colors">
        ...
        <header class="bg-white shadow-sm ring-1 ring-gray-200 z-10 w-full">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center flex-1">
                    ...
                    <h2 class="hidden md:block text-lg font-bold text-gray-900 py-2">Commissions Hub</h2>
                </div>
        ...
        <main class="flex-1 overflow-y-auto w-full bg-gray-50">
            ...
            <div class="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 pt-4">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <a href="{{ route('admin.commissions.index') }}" class="border-primary text-primary whitespace-nowrap border-b-2 py-4 px-1 text-sm font-bold">
                        Overview
                    </a>
                    ...
                    <a href="{{ route('admin.commissions-driver.index') }}" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-medium transition-colors">
                        Driver Commissions
                    </a>
                </nav>
            </div>
            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="mb-6 flex flex-col justify-between items-start space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">High-level financial summaries generated from all processed platform modules.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 relative overflow-hidden group">
                        <div class="absolute top-0 right-0 p-4 opacity-10 transform scale-150 group-hover:scale-110 transition-transform">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 relative overflow-hidden group">
                        <div class="absolute top-0 right-0 p-4 opacity-10 transform scale-150 group-hover:scale-110 transition-transform">
                            <svg class="w-24 h-24 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path></svg>
                        </div>
                        <div class="flex items-center z-10 relative">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-semibold text-gray-500 uppercase tracking-wider">Restaurant Share</p>
                                <h3 class="text-3xl font-extrabold text-gray-900 mt-1">$28,500.00</h3>
                            </div>
                        </div>
                        <div class="mt-4 flex items-center text-sm z-10 relative">
                            <span class="text-gray-500 font-medium">Avg Commission: <span class="text-gray-900">15%</span></span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5 relative overflow-hidden group">
                        <div class="absolute top-0 right-0 p-4 opacity-10 transform scale-150 group-hover:scale-110 transition-transform">
                            <svg class="w-24 h-24 text-yellow-600" fill="currentColor" viewBox="0 0 20 20"><path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"></path><path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v6.05A2.5 2.5 0 0115.95 16H17a1 1 0 001-1v-5a1 1 0 00-.293-.707l-2-2A1 1 0 0015 7h-1z"></path></svg>
                        </div>
                        <div class="flex items-center z-10 relative">
                        ...
                        <div class="mt-4 flex items-center text-sm z-10 relative">
                             <span class="text-gray-500 font-medium">Avg Commission: <span class="text-gray-900">10% + Tips</span></span>
                        </div>
                    </div>
                </div>

                <!-- Explanation Panel -->
                <div class="bg-indigo-50 border border-indigo-100 rounded-xl p-6 text-indigo-900 flex flex-col md:flex-row items-center justify-between mb-8">
                    <div>
                        <h4 class="font-bold text-lg mb-1">Detailed Breakdowns Available</h4>
                        <p class="text-sm opacity-80">Navigate to the sub-sections to manage specific deductions, configure rates, and review order-level commission details.</p>
                    </div>
                    <div class="mt-4 md:mt-0 flex space-x-3">
                        <a href="{{ route('admin.commissions-restaurant.index') }}" class="px-4 py-2 border border-indigo-200 rounded-lg bg-white shadow-sm font-medium hover:bg-gray-50 transition-colors text-sm">Review Vendors</a>
                        <a href="{{ route('admin.commissions-driver.index') }}" class="px-4 py-2 border border-indigo-200 rounded-lg bg-white shadow-sm font-medium hover:bg-gray-50 transition-colors text-sm">Review Fleet</a>
                    </div>
                </div>
