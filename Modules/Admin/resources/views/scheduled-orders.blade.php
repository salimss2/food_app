...
<head>
    ...
    <title>Scheduled Orders - Admin Dashboard</title>
    <!-- Tailwind CSS -->
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:flex lg:flex-col shadow-sm">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow shadow-inner">
            <ul class="flex flex-col py-4 space-y-1 px-3 mb-10">
                ...
                <li>
                    <a href="{{ route('admin.scheduled-orders.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-primary bg-indigo-50 border-l-4 border-primary px-6 rounded-r-lg group transition-colors">
    ...
    <div class="flex-1 flex flex-col min-w-0 transition-all duration-300">
                ...
                <div class="flex items-center flex-1">
                    ...
                    <div class="hidden md:flex w-full max-w-md ml-4">
                        <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                            ...
                            <input type="text" placeholder="Search scheduled orders..." class="w-full h-10 pl-10 pr-3 rounded-lg border border-gray-200 bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white focus:border-transparent transition-all sm:text-sm">
                        </div>
                    </div>
                </div>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto w-full">
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Scheduled Orders</h2>
                    <p class="text-sm text-gray-500 mt-1">Orders set to be delivered at a specific future date and time.</p>
                </div>
            </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        ...
                                        <p><span class="font-medium text-gray-800">Driver Assigned:</span> <span id="detailDriver">Scheduled</span></p>
                                    </div>
                                </div>
                            </div>
                            
                            <div>
                                <h4 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 text-indigo-600">Scheduled Time</h4>
