                ...
                <div class="flex items-center flex-1">
                    ...
                    <div class="hidden md:flex w-full max-w-md ml-8">
                        <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                            ...
                            <input type="text" id="driverSearch" placeholder="Search driver name..." class="w-full h-10 pl-10 pr-3 rounded-lg border border-gray-200 bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white focus:border-transparent transition-all sm:text-sm">
                        </div>
                    </div>
                </div>
