    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full lg:translate-x-0 lg:static lg:inset-0 lg:flex lg:flex-col shadow-sm">
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow shadow-inner">
            <ul class="flex flex-col py-4 space-y-1 px-3 mb-10">
                ...
                <li>
                    <a href="{{ route('admin.order-history.index') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-primary bg-indigo-50 border-l-4 border-primary px-6 rounded-r-lg group transition-colors">
                ...
                <div class="flex items-center flex-1">
                    ...
                    <div class="hidden md:flex w-full max-w-md ml-4">
                        <div class="relative w-full text-gray-400 focus-within:text-gray-600">
                            ...
                            <input type="text" placeholder="Search order history by ID or customer..." id="historySearch" oninput="renderHistoryTable()" class="w-full h-10 pl-10 pr-3 rounded-lg border border-gray-200 bg-gray-50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:bg-white focus:border-transparent transition-all sm:text-sm">
                        </div>
                    </div>
                </div>
        ...
        <main class="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto w-full">
            ...
            <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Archive of all completed and cancelled past orders.</p>
                </div>
                <div class="flex space-x-2">
                    <select id="historyFilter" class="block w-full rounded-lg border-gray-300 py-2 pl-3 pr-10 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary shadow-sm bg-white" onchange="renderHistoryTable()">
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl modal-content">
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-gray-900 flex items-center space-x-2" id="modalOrderId">Order Reference</h3>
                    ...
                    <div class="px-6 py-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <div class="flex items-center space-x-3 bg-gray-50 p-3 rounded-lg border border-gray-100">
                                        <div class="flex-shrink-0 h-10 w-10 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center font-bold" id="detailCustomerInitials">
                                        </div>
                                        <div>
                                    ...
                                    <div class="mt-2 text-sm text-gray-600">
                                        <span class="font-medium text-gray-800">Delivered To:</span>
                            ...
                            <div>
                                <h4 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Final Status</h4>
                                <div class="mb-4 flex items-center">
                                    <span id="detailCurrentBadge"></span>
                                    <span class="ml-3 text-xs text-gray-500" id="detailTime"></span>
                                </div>

                                <h4 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-6">Order Items Archive</h4>
                                <div class="bg-gray-50 rounded-lg border border-gray-100 overflow-hidden opacity-90">
                                    ...
                                    <div class="bg-gray-100 px-4 py-3 border-t border-gray-200 flex justify-between items-center sm:px-6">
                                        <span class="text-sm font-semibold text-gray-900">Final Price</span>
