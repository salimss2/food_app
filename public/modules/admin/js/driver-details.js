...
// Dummy Data Arrays
        ...
        function initData() {
            ...
            dummyOrders.forEach(o => {
                const badgeClass = o.status === 'Delivered' ? 'bg-green-100 text-green-800' : 
                ...
                ordersTbody.innerHTML += `
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">${o.rest}</td>
                        <td class="px-6 py-4">${o.cust}</td>
                        <td class="px-6 py-4 font-semibold text-gray-900">${o.amt}</td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <button onclick="openTimeline('${o.id}')" class="text-primary hover:text-primary_dark text-xs font-semibold flex items-center focus:outline-none">
